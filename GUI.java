...
public class GUI {
	...
	private PassagerVolGUI listePasP;
	...
	protected void switchPanelEfface() {
		panel.removeAll();
		volsEffP = new VolsGUI_E(v, this);
		panel.add(volsEffP, BorderLayout.CENTER);
	...
	protected void switchPanelPassEff() {
		...
		panel.add(panelPE, BorderLayout.CENTER);
		panel.add(js, BorderLayout.SOUTH);
		panel.repaint();
		panelPE.repaint();
		this.frame.setVisible(true);
	...
	protected void switchPanelCreer() {
		panel.removeAll();
		volsP = new VolsGUI(v, this);
		panel.add(volsP, BorderLayout.CENTER);
		panel.add(js, BorderLayout.SOUTH);
		panel.repaint();
		this.volsP.repaint();
		this.frame.setVisible(true);
	...
	protected void switchPanelListe() {
		panel.removeAll();
		listeP = new ListeGUI(v, this);
		panel.add(listeP, BorderLayout.CENTER);
		panel.add(js, BorderLayout.SOUTH);
		panel.repaint();
		this.listeP.repaint();
		this.frame.setVisible(true);
	...
	protected void switchPanelListeVols() {
		panel.removeAll();
		listeVolP = new ListeVolsGUI(v, this);
		panel.add(listeVolP, BorderLayout.CENTER);
		panel.add(js, BorderLayout.SOUTH);
		panel.repaint();
	...
	protected void switchPanelPassListe() {
		panel.removeAll();
		listePasP = new PassagerVolGUI(v, this);
		panel.add(listePasP, BorderLayout.CENTER);
		panel.add(js, BorderLayout.SOUTH);
		panel.repaint();
		listePasP.repaint();
		this.frame.setVisible(true);
	...
	public static void main(String[] args) {		
		...
		gui.panel.add(gui.volsP, BorderLayout.CENTER);
		gui.panel.add(gui.js, BorderLayout.SOUTH);
